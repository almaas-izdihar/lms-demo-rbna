              ...
              {[
                {
                  ...
                  description: "Build engaging courses easily",
                  features: ["Interactive Content", "Multimedia Support", "Assessment Tools"]
                },
                {
                  icon: <Users className="h-8 w-8" />,
                  title: "Student Management",
                  description: "Track progress effortlessly",
                  features: ["Enrollment System", "Progress Tracking", "Automated Notifications"]
                },
                {
                  icon: <BarChart className="h-8 w-
